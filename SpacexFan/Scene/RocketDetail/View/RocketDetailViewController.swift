...
class RocketDetailViewController: UIViewController {
    ...
    func configure() {
        ...
        rocketSuccessRatePct.text = "Success Rate Pct: \(rocket.successRatePct)"
        rocketSuccessRatePct.textColor = .black

        let descriptionText = rocket.description
...
extension RocketDetailViewController: UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.design(rocketImageURL: rocket.images[indexPath.row])
        return cell
    }
}
